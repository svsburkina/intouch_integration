...
from .utils import AGENCY_CODE, LOGIN_AGENT, PASSWORD_AGENT, SERVICE_CODES


class IntouchTransactionRequest(models.Model):
    _name = 'intouch_integration.intouch_transaction_request'
    ...
    def on_create_trigger(self):
        ...
        response = requests.post(url, params=params, json=transaction_data)
